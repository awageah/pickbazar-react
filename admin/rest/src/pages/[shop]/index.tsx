      ...
      {!is_active && (
        <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
          <div className="flex items-start gap-3">
            {/* Inline info icon — no external icon library required */}
            <svg
            ...
            <div>
              <h3 className="text-sm font-medium text-blue-800">
                {t('common:text-shop-under-review', {
                  defaultValue: 'Your shop is under review',
                })}
              </h3>
              <p className="mt-1 text-sm text-blue-700">
                {t('common:text-shop-under-review-description', {
                  defaultValue:
                    'Our team is reviewing your shop details. You\u2019ll receive an email once approved. This usually takes 1\u20132 business days.',
                })}
              </p>
            </div>
          </div>
