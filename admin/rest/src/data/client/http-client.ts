...
export class HttpClient {
  ...
  static async put<T>(url: string, data: unknown, options?: { params?: Record<string, string | undefined> }) {
    const response = await Axios.put<T>(url, data, { params: options?.params });
    return response.data;
  }
